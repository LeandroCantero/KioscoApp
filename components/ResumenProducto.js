  ...
  return (
    <div className='shadow p-5 mb-3 flex gap-10 items-center'>
      ...
      <div className="md:w-4/6">
        ...
        <p className="text-xl font-bold mt-2 text-amber-500">Precio: {formatearDienero(producto.precio)}</p>
        <p className="text-sm text-gray-700 mt-2">Subtotal: {formatearDienero(producto.precio * producto.cantidad)}</p>
      </div>
